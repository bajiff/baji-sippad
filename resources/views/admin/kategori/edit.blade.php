...
@section('header', 'Edit Kategori Pelatihan')
    ...
    <div class="card p-6">
        <form method="POST" action="{{ route('admin.kategori.update', $kategori) }}">
            ...
            <div class="mb-6">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="3" class="w-full px-3 py-2 border border-[var(--color-border)] rounded text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-link)]">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
